        ...
        <div className='w-full hidden md:flex px-10 pt-5'>
            <div className="profile flex md:scale-95 lg:scale-100 items-center w-full justify-between" >
                ...
                <div className='flex gap-2 text-sm'>
                    <select name="" id="" className='border-2 border-black rounded-full p-2'>
                        <option value="" className='bg-neutral-600 rounded-full'>jobs available</option>
                    </select>
                    <select name="" id="" className='border-2 border-black rounded-full p-2'>
                        <option value="" className='bg-neutral-600 rounded-full'>internet info.</option>
                    </select>
                </div>
